      ...
      <Paper radius="md" withBorder style={{ overflow: 'hidden', display: 'flex', flexDirection: 'column' }} h={570}>
        ...
        <ScrollArea style={{ flex: 1 }}>
            <Table striped highlightOnHover>
              ...
              <Table.Tbody>
                {loadingDatos ? (<Table.Tr><Table.Td colSpan={6} ta="center" c="dimmed" p="xl">Sincronizando caja con potreros y animales...</Table.Td></Table.Tr>) : movimientosFiltrados.length === 0 ? (<Table.Tr><Table.Td colSpan={6} ta="center" c="dimmed" p="xl">No hay movimientos que coincidan con tus filtros.</Table.Td></Table.Tr>) : (
